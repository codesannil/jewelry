...
export function renderHomeView(container) {
  ...
  container.innerHTML = `
    ...
    <!-- Physical Store Callout Banner -->
    <section class="section-padding store-banner-section">
      <div class="page-container text-center">
        <span class="gold-subtitle">Physical Showroom</span>
        <h2 class="store-banner-title">Visit Aurelia Fine Jewelry</h2>
        <p class="store-banner-desc">Experience the radiance of real 22K gold and certified solitaire diamonds in person at our flagship showroom.</p>
        <p class="store-address-text">📍 ${SHOP_INFO.address}, ${SHOP_INFO.cityStateZip}</p>
        <div class="hero-btn-group justify-center mt-4">
          <a href="#contact" class="btn btn-gold btn-lg">Store Info & Map</a>
          <a href="${getAppointmentWhatsAppUrl()}" target="_blank" rel="noopener" class="btn btn-whatsapp btn-lg">
